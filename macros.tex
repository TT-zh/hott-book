...
% Localization flag fallback (for targets that include macros.tex directly).
...
\makeatletter
\ifOPTchinese
\newcommand{\sectionNotes}{\phantomsection\section*{附注}\addcontentsline{toc}{section}{附注}\markright{\textsc{第 \thechapter 章 附注}}}
\newcommand{\sectionExercises}[1]{\ifdef{\OPTexerciseperpage}{\newpage}{}\phantomsection\section*{练习}\addcontentsline{toc}{section}{练习}\markright{\textsc{第 \thechapter 章 练习}}}
\else
...
\ifOPTchinese
% Display format for chapters in Chinese mode.
\crefformat{chapter}{第#2#1#3章}
\Crefformat{chapter}{第#2#1#3章}
\crefrangeformat{chapter}{第#3#1#4章至第#5#2#6章}
\Crefrangeformat{chapter}{第#3#1#4章至第#5#2#6章}
\crefmultiformat{chapter}{第#2#1#3章}{、第#2#1#3章}{、第#2#1#3章}{、第#2#1#3章}
\Crefmultiformat{chapter}{第#2#1#3章}{、第#2#1#3章}{、第#2#1#3章}{、第#2#1#3章}
\crefrangemultiformat{chapter}{第#3#1#4章至第#5#2#6章}{、第#3#1#4章至第#5#2#6章}{、第#3#1#4章至第#5#2#6章}{、第#3#1#4章至第#5#2#6章}
\Crefrangemultiformat{chapter}{第#3#1#4章至第#5#2#6章}{、第#3#1#4章至第#5#2#6章}{、第#3#1#4章至第#5#2#6章}{、第#3#1#4章至第#5#2#6章}
\fi
